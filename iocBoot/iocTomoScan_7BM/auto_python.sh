...
IOC_STARTUP_DIR=/home/beams/7BMB/epics-ts/synApps/support/tomoscan/iocBoot/iocTomoScan_7BM
IOC_BINARY="python -i"
IOC_NAME=TomoScan_python
...
IOC_STARTUP_FILE="start_tomoscan_7bm.py"
